...
describe('E2E: Uber-Style Booking Flow', () => {
    ...
    describe('1. User Registration & Authentication', () => {
        test('Register customer', async () => {
            ...
            try {
                ...
                if (existingUser) {
                    await database_1.default.user.delete({ where: { id: existingUser.id } });
                }
            }
            catch (_) { }
    ...
    describe('2. Service Creation & Admin Approval', () => {
        ...
        test('Admin approves service', async () => {
            ...
            const serviceExists = await database_1.default.service.findUnique({
                where: { id: serviceId }
            });
    ...
    describe('3. Uber-Style Booking Request Flow', () => {
        ...
        test('Provider can decline booking request', async () => {
            ...
            const bookingRes = await (0, supertest_1.default)(app)
                .post('/bookings')
                .set('Authorization', `Bearer ${customerToken}`)
                .send({
                serviceId: serviceId,
            ...
            const declineRes = await (0, supertest_1.default)(app)
