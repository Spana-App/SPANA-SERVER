...
userSchema.pre('save', function (next) {
    ...
    if (user.role === 'service provider') {
        ...
        const hasServiceArea = user.serviceArea && user.serviceArea.radiusInKm > 0 && user.serviceArea.baseLocation && Array.isArray(user.serviceArea.baseLocation.coordinates) && user.serviceArea.baseLocation.coordinates.some((c) => c !== 0);
        const verifiedDocExists = Array.isArray(user.documents) && user.documents.some((d) => d.verified);
