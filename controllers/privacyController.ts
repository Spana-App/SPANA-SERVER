...
exports.exportUserData = async (req: any, res: any) => {
  try {
...
exports.deleteUserAccount = async (req: any, res: any) => {
  try {
    const userId = req.user.id;
...
exports.updateConsent = async (req: any, res: any) => {
  try {
...
exports.getPrivacyStatus = async (req: any, res: any) => {
  try {
    const user = await prisma.user.findUnique({
